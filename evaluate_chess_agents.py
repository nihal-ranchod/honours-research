"""
File to run evaluation of all bots in a tournament style environment.
...
def evaluate_bots(game, bot1, bot2, num_games):
    ...
    3. For each game:
        ...
        d. Updates the results dictionary based on the game outcome.
...
def main(argv):
    ...
    with open("standard_chess_evaluation_results.txt", "w") as f:
